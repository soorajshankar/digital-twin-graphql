...
export function setupDRACOLoader(THREE) {
    ...
    _initDecoder() {
      ...
      if (useJS) {
        ...
        librariesPending.push(
          this._loadLibrary("draco/draco_wasm_wrapper.js", "text")
        );
        librariesPending.push(
          this._loadLibrary("draco/draco_decoder.wasm", "arraybuffer")
        );
      }
...
export const setupRGBELoader=(THREE)=>{
...
export const setupGLTFLoader = (THREE) => {
